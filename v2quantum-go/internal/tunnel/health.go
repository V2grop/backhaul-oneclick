...
func (r *Runtime) ServeHealth(ctx context.Context) error {
	...
	mux.HandleFunc("/metrics", func(w http.ResponseWriter, _ *http.Request) {
		...
		_, _ = fmt.Fprintf(w,
			...
			s.FusionLinks, s.FusionFailovers, s.FusionReplayedBytes)
	})
	server := &http.Server{
